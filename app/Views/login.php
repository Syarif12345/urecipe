						...
						<div class="container-fluid py-5 mx-auto">
							...
							<div class="card mx-auto rounded-0 border-0" style="max-width: 400px; background-color: rgba(255,255,255,0.93);">
								<div class="card-body" style="padding: 40px;">
									<form id="login-form" name="login-form" class="mb-0" action="<?= base_url('login/masuk') ?>" method="post">
										...
										<div class="row">
											...
											<div class="col-8 form-group">
												<input type="submit" class="button button-3d button-black m-10" id="login-form-submit" name="login-form-submit" value="Login">
												<a href="<?= base_url('login/register') ?>" class="float-right">Belum punya akun? Daftar disini</a>
											</div>
										</div>
									</form>
