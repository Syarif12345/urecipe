...
<body class="stretched">
	...
	<div id="side-panel" class="dark" style="background: #101010 url(<?= base_url('demos/burger/images/icon-bg-white.png') ?>) repeat center center;">
	...
	<div id="wrapper" class="clearfix">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="<?= base_url('home') ?>" class="standard-logo" data-dark-logo="<?= base_url() ?>demos/burger/images/logo-dark.png" data-sticky-logo="<?= base_url() ?>demos/burger/images/logo-sticky.png"><img src="<?= base_url() ?>demos/burger/images/logo.png" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="<?= base_url() ?>demos/burger/images/logo-dark@2x.png" data-sticky-logo="<?= base_url() ?>demos/burger/images/logo-sticky@2x.png"><img src="<?= base_url() ?>demos/burger/images/logo@2x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-100 page-section slide-img include-header" data-animate="img-to-right" style="background: url(<?= base_url('demos/burger/images/hero.jpg') ?>) center center no-repeat; background-size: cover;">
						...
						<div class="row">
							<div class="col-lg-6 col-md-8 dotted-bg parallax" data-start="top: 0px; opacity: 1" data-400="top: 50px; opacity: 0.3">
								<div class="emphasis-title" data-animate="fadeInUp">
									<div class="before-heading font-secondary color">Resep terbaik ada disini!</div>
									<h1 class="font-border">U Recipe </h1>
								</div>
								<p class="lead text-white-50" data-animate="fadeInUp" data-delay="100">URECIPE adalah sebuah website resep makanan yang menawarkan beragam inspirasi dan panduan memasak untuk memuaskan selera makan Anda.</p>
								<a data-scrollto="#story" data-easing="easeInOutExpo" data-speed="1250" class="button button-large button-rounded px-4 button-border button-light button-white font-weight-semibold" data-animate="fadeInUp" data-delay="200">Lihat Resep</a>
					...
					<div class="section m-0 p-0">
						<div class="row align-items-stretch clearfix">
							...
							<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #0A0A0A;">
								<div class="cat-img"><img  data-animate="fadeInRight" src="demos/burger/images/soto.png" alt="Category Image"></div>
								<div class="cat-text">
									<h2 class="font-weight-bold ls1 text-uppercase mb-5">Makanan</h2>
									...
									<a href="<?= base_url('home/makanan') ?>">Lihat Selengkapnya
								</a>
								</div>
							...
							<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #1B1B1B;">
								<div class="cat-img"><img  data-animate="fadeInRight" src="demos/burger/images/cat/5.png" alt="Category Image"></div>
								<div class="cat-text">
									<h2 class="font-weight-bold ls1 text-uppercase mb-5">Kue</h2>
									...
									<a href="<?= base_url('home/kue') ?>">Lihat Selengkapnya</a>
								</div>
							</div>
							...
							<div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #262626;">
								...
								<div class="cat-text">
									<h2 class="font-weight-bold ls1 text-uppercase mb-5">Minuman</h2>
