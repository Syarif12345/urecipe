					...
					<div class="section m-0 p-0">
                        ...
                        <?php foreach ($resep as $item) { ?>
                            ...
                            <div class="item-categories overflow-hidden col-md-4 dark col-padding position-relative" style="background-color: #0A0A0A;">
								<div class="cat-img"><img  data-animate="fadeInRight" src="<?php echo base_url() ?>demos/burger/images/soto.png" alt="Category Image"></div>
								<div class="cat-text">
									...
									<a href="<?= base_url('home/detail_makanan?id='.$item->id_resep); ?>">Lihat Selengkapnya</a>
								</div>
