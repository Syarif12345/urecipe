	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div class="section p-0 m-0 h-100 position-absolute" style="background: url(<?= base_url ('demos/burger/images/hero.jpg')?>) center center no-repeat; background-size: cover;"></div>
						...
						<div class="container-fluid py-5 mx-auto">
							...
							<div class="card mx-auto rounded-0 border-0" style="max-width: 400px; background-color: rgba(255,255,255,0.93);">
								<div class="card-body" style="padding: 40px;">
									<form id="login-form" name="login-form" class="mb-0" action="<?= base_url('login/proses_register') ?>" method="post">
								...
								<?php endif; ?>
										...
										<div class="row">
											...
											<div class="col-8 form-group">
												<button class="button button-3d button-black m-10" id="login-form-submit" name="login-form-submit" value="login">Register</button>
												<a href="<?= base_url('login/index') ?>" class="float-right">Sudah punya akun? Login disini</a>
											</div>
										</div>
									</form>
